...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Poll.etiquetas2'
        db.add_column(u'polls_poll', 'etiquetas2',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Poll.etiquetas2'
        db.delete_column(u'polls_poll', 'etiquetas2')
    ...
    models = {
        ...
        u'polls.poll': {
            ...
            'etiquetas2': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
